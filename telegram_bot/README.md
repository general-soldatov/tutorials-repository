...
* [Отрисовка графиков посредством Matplotlib в окне Tkinter](https://ru.stackoverflow.com/questions/602148/%D0%9E%D1%82%D1%80%D0%B8%D1%81%D0%BE%D0%B2%D0%BA%D0%B0-%D0%B3%D1%80%D0%B0%D1%84%D0%B8%D0%BA%D0%BE%D0%B2-%D0%BF%D0%BE%D1%81%D1%80%D0%B5%D0%B4%D1%81%D1%82%D0%B2%D0%BE%D0%BC-matplotlib-%D0%B2-%D0%BE%D0%BA%D0%BD%D0%B5-tkinter)
* [Text in Matplotlib](https://matplotlib.org/stable/users/explain/text/text_intro.html)
* [Boosters.pro — крупнейшая в России и Восточной Европе платформа для проведения контеcтов по анализу данных.](https://boosters.pro/)
...
* [pyTelegramBotAPI’s documentation](https://pytba.readthedocs.io/en/latest/index.html)
...
* [Словарь «SQL для начинающих»](https://six-quark-9ca.notion.site/SQL-a0dcf2e0ede0437a9c83d031e7854304)
...
* [Почему стоит научиться «парсить» сайты, или как написать свой первый парсер на Python](https://habr.com/ru/articles/568334/)

# Python
* [Как добавить элемент в словарь Python](https://python-teach.ru/python-dlya-nachinayushhih/kak-dobavit-element-v-slovar-python/)
* [Как использовать функцию compile() в Python](https://python-lab.ru/kak-ispolzovat-funktsiyu-compile-v-python)
* [Python sleep(): Как выполнить код с задержкой?](https://python-scripts.com/sleep)
* [Окно приложения Tkinter](https://metanit.com/python/tkinter/1.2.php)
* [Обучение Python GUI (уроки по Tkinter)](https://pythonru.com/uroki/obuchenie-python-gui-uroki-po-tkinter)
...
* [БЕСПЛАТНЫЕ ВЕБИНАРЫ innopolis](https://stc.innopolis.university/webinars)
* [Глоссарий](https://netology.ru/glossariy)
